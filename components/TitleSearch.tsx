...
export function TitleSearch({ currentTitle = '' }: TitleSearchProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-2 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      <label htmlFor="title-search" className="block text-sm font-medium text-slate-700">Buscar título</label>
